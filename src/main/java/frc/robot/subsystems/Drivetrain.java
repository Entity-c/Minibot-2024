...
public class Drivetrain extends SubsystemBase {
  ...
  //TODO 0: this code is prewritten to define the motors the robot will be using 
  // you dont need to change any of this code but you read it and try to figure out what it is doing 
   ...
   * it drives similar to how a tank drives. Each side is driven at a certian speed. To turn 
  ...
  public void tankDrive(){
    ...
    // this is a good way to make sure you are calling the correct methods/didnt make syntax mistakes
